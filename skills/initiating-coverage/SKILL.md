...
3. **Target data freshness:** Use FY2024/2025 annual reports, or latest quarterly results
4. **Never use pre-2024 data** for revenue, earnings, or market metrics without explicit disclosure

**Per-Task Requirements:**
- **Task 1 (Research)**: Use "[Company] FY2024 annual results" or "[Company] Q[X] 2025 earnings"
...
- [ ] All revenue/earnings numbers include explicit fiscal year (FY2024/2025)
